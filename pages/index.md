...
- [Concepts](concepts.md) — level 1, 233 nodes across 7 repos.
- [Components](components.md) — level 2, 188 nodes, each documented by a man page.
- [`corpus.jsonld`](corpus.jsonld) — the full machine corpus (197 man pages), consumable by agents directly over HTTP once this site is published; JSON-LD with `@id` IRIs under `http://knuckles.team/kg#`, the same namespace Epistemic Graph's own ontology uses.
